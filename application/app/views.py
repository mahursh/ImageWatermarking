...
def index():
    ...
    if request.method == 'POST':
        ...
        if option == 'logo_watermark':
            ...
            logo_name = logo_upload.filename
            ...
            full_file_name = 'static/uploads/image.png'
            return render_template('index.html', full_file_name=full_file_name)

        else:
            text_watermark = request.form['text_watermark']

            cv2.putText(image_logow, text="Mahoor.Sh", org=(w_image - 95, h_image - 10),
            ...
            full_file_name = 'static/uploads/image1.png'
            return render_template('index.html' , full_file_name=full_file_name)
